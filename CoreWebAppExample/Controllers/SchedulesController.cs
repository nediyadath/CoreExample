...
namespace CoreWebAppExample.Controllers
{
    public class SchedulesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,docID,schedule")] Schedule schedule)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,docID,schedule")] Schedule schedule)
        {
            if (id != schedule.id)
            {
                return NotFound();
